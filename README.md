...
<nav id='menu'>
  <input type='checkbox' id='responsive-menu' onclick='updatemenu()'><label></label>
  <ul>
    <img src="/Imagem/expedicao33.jpg" alt="" width="40px" height="40px">
    <li><a href='#'>Início</a></li>
    <li><a href='/tiposdeanimais.html'>Tipos de Animais</a></li>
    <li><a href='/exemplos.html'>Exemplos de Animais</a></li>
  </ul>
</nav>
<button type="submit" class="btn btn-primary botao-login" style="background-color: darkgray; border: black; position: relative;"><a href="/index.html">Clique aqui para ir para a parte do jogo obscure expedition 33</a></button>
...
<nav id='menu'>
  ...
  <ul>
    <img src="/Imagem/expedicao33.jpg" alt="" width="40px" height="40px">
    <li><a href='/animaisdiferentes.html'>Início</a></li>
    <li><a href='/tiposdeanimais.html'>Tipos de Animais</a></li>
    <li><a href='#'>Exemplos de Animais</a></li>
  </ul>
</nav>
<body>
...
<div class="grid">
 ...
 <h1>Camarão mantis </h1>
    <img src="https://wl-incrivel.cf.tsp.li/resize/728x/webp/72e/0dc/1720135e359f79f814ca3bfb20.jpg.webp" width="300" height="200"  alt="">


 <h1>Aranha-tartaruga laranja</h1>
    <img src="https://wl-incrivel.cf.tsp.li/resize/728x/webp/c8d/e1b/e09e535487bbc097b274bf7b40.jpg.webp" width="300" height="200"  alt="">


 <h1>Panda vermelho</h1>
    <img src="https://wl-incrivel.cf.tsp.li/resize/728x/webp/86b/a24/ee4308503bb9dadee824528010.jpg.webp" width="300" height="200"  alt="">


 <h1>Peixe loro azul</h1>
    <img src="https://wl-incrivel.cf.tsp.li/resize/728x/webp/498/0db/be62ee5029a588b0e2cb83ee54.jpg.webp" width="300" height="200"  alt="">

</div>
  

<div class="coluna">
   <h3>Animais Fascinantes do Reino Animal: Dragão Azul, Lagarto Pogona, Camarão Mantis, Aranha-Tartaruga Laranja, Panda Vermelho e Peixe Loro Azul</h3> 
A natureza, com toda sua diversidade e complexidade, está cheia de criaturas extraordinárias e muitas vezes inusitadas. Entre elas, encontramos seres que parecem saídos de um conto de fantasia, mas que são muito reais e habitam nosso planeta. Entre esses animais incríveis estão o dragão azul, o lagarto pogona, o camarão mantis, a aranha-tartaruga laranja, o panda vermelho e o peixe loro azul. Cada um desses animais possui características únicas e comportamentos impressionantes que merecem ser explorados. Vamos conhecer mais sobre eles?

1. Dragão Azul (Himachirus huso)
O dragão azul é uma das criaturas marinhas mais fascinantes e misteriosas que existem. Seu nome, "dragão", vem de sua aparência que lembra uma criatura mítica, com cores vibrantes e formas curiosas. Também conhecido como nudibrânquio, esse molusco marinho é pequeno, mas exibe um espetáculo de cores, variando do azul vibrante ao prateado. Ele vive em águas quentes e salgadas, e é frequentemente encontrado em recifes de corais ou na superfície do oceano.

O que torna o dragão azul ainda mais incrível é sua habilidade de capturar e armazenar veneno. Ele se alimenta de pequenas criaturas como caravelas (medusas), que possuem tentáculos extremamente venenosos. O dragão azul não apenas se alimenta dessas criaturas, mas também usa seu veneno para se defender de predadores. Além disso, o dragão azul tem uma estrutura corporal peculiar: seu corpo é achatado e possui uma espécie de nadadeira que se assemelha a uma asa, dando-lhe uma aparência ainda mais fantástica.

2. Lagarto Pogona (Pogona vitticeps)
O lagarto pogona, também conhecido como dragão barbudo, é um réptil originário da Austrália. Este animal ganhou popularidade como animal de estimação devido à sua natureza amigável e sua aparência peculiar. Os lagartos pogona são conhecidos por suas “barbas”, que são formadas por escamas ao redor do pescoço, o que lhes dá um visual de um verdadeiro dragão.

Esse lagarto é uma excelente mascote, pois é fácil de cuidar e pode ser socializado com seres humanos desde uma idade jovem. Eles têm uma dieta variada, comendo desde vegetais até pequenos insetos. O comportamento do lagarto pogona é bastante interessante: quando se sente ameaçado ou excitado, ele expande a "barba", tornando-se visualmente maior para impressionar possíveis predadores.

Além de ser um ótimo companheiro, os pogonas são também incríveis caçadores, usando sua língua pegajosa para capturar presas e se alimentando com voracidade. Eles são ativos durante o dia e gostam de se aquecer ao sol, como a maioria dos répteis.

3. Camarão Mantis (Stomatopoda)
...
<div class="video-bg">
    <iframe 
      src="https://www.youtube.com/embed/8U_nLVItqdw?autoplay=1&mute=1&loop=1&controls=0&playlist=8U_nLVItqdw&modestbranding=1&showinfo=0&rel=0
"
      frameborder="0"
      allow="autoplay; fullscreen"
      allowfullscreen>
...
<nav id='menu'>
  ...
  <ul>
    <img src="/Imagem/expedicao33.jpg" alt="" width="40px" height="40px">
    <li><a href='/animaisdiferentes.html'>Início</a></li>
    <li><a href='#'>Tipos de Animais</a></li>
    <li><a href='/exemplos.html'>Exemplos de Animais</a></li>
  </ul>
</nav>
<body>
    <h1>TIPOS DE ANIMAIS DIFERENTES</h1>
    <p style="color: black;">  O reino animal é repleto de criaturas fascinantes, muitas vezes desconhecidas do grande público. Algumas chamam a atenção por suas cores, outras por habilidades extraordinárias. Conheça agora alguns dos animais mais incríveis do planeta:
...
Entre as aves, o pato-mandarim se destaca por suas cores vibrantes e exóticas. Nativo da Ásia, esse pato é considerado símbolo de amor e fidelidade, pois os casais tendem a permanecer juntos por toda a vida.
